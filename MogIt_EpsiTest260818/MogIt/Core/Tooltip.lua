...
--mog.tooltip.model:SetSheathed(true)
...
mog.tooltip.model:SetPropagateKeyboardInput(true) --epsi edit
mog.tooltip.model:SetScript("OnKeyDown", function(self, key)
	--print(key)
	if key ~= sheatheKey then --epsilon sheathe
		...
		elseif toggle == 1 then
			mog.tooltip.model:SetSheathed(false)
			toggle = 0;
		end
